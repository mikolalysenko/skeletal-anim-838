...
UserInterface::UserInterface() {
  { mainWindow = new Fl_Double_Window(600, 700, "Skeletal Anim");
    mainWindow->user_data((void*)(this));
    { Fl_Group* o = new Fl_Group(-5, 0, 830, 697);
      { Fl_Group* o = new Fl_Group(0, 0, 800, 400);
        { view = new glView(0, 0, 600, 400, "This is the OpenGL view");
      ...
      { Fl_Group* o = new Fl_Group(-5, 400, 807, 297);
        ...
        { Fl_Group* o = new Fl_Group(0, 434, 565, 263);
          ...
          { Fl_Box* o = new Fl_Box(518, 456, 40, 20);
            Fl_Group::current()->resizable(o);
          } // Fl_Box* o
