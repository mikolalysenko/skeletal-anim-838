#!/bin/bash
./motool -c data/EAStrafe/straight/FABMGWK01-marking_walk_forward.bvh > tmp/walk.mog
...
./motool -a data/EAStrafe/turns/1_RP_FIFA2005_APR_605_1.bvh tmp/walk6.mog > tmp/walk7.mog
...
./motool -path data/test.spline tmp/walk_final.mog > test2.bvh
